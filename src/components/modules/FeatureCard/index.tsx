...
type LandingPageCardProps = Omit<
    ...
    "image" | "p286162ndaveoaklone" | "p3bedroom" | "bathcounter" | "sqftcounter" | "p1bath" | "viewDetails" | "price"
> &
    Partial<{
        image: string;
...
const FeatureCard: React.FC<LandingPageCardProps> = (props) => {
    return (
        <>
                ...
                <div className="bg-gray-51 border border-red-101 border-solid flex flex-col items-start justify-start px-5 py-[30px] rounded-bl-[10px] rounded-br-[10px] w-full">
                    <div className="flex flex-col gap-[27px] items-start justify-start w-full">
                        ...
                        <div className="flex flex-row gap-[31px] items-center justify-start w-full">
                            <Button className="bg-gray-900 cursor-pointer flex-1 font-Poppins font-semibold py-[13px] rounded-[10px] text-base text-center text-white w-full">
                                {props?.viewDetails}
                            </Button>
                            <Text
