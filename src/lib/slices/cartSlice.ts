...
export const incrementQuantity = createAsyncThunk("cart/incrementQuantity", async (payload: string) => {
    try {
...
export const decrementQuantity = createAsyncThunk("cart/decrementQuantity", async (payload: string) => {
    try {
        const response = await axios.post("/api/cart", {
            action: "decrement",
            product: payload,
...
export const removeItem = createAsyncThunk("cart/removeItem", async (payload: string) => {
    try {
